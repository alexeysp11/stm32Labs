...
* Filename  	: pin.hpp
* 
* Details   	: Contains definition of a structure `Pin` and many additional
* 				  structures (`PinConfigurable`, `PinReadable`, `PinWriteable`, 
*				  `PinReadableConfigurable`, `PinWriteableConfigurable` and 
*				  `PinAlmighty`). 
*
* Structure `Pin` implements methods for setting, resetting and toggling a pin, 
* as well as for getting a value from a pin and getting if a high value is set.
*
* Additional stuructures are not imlemented yet. 
* 
*******************************************************************************/
