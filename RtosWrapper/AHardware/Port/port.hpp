...
* Filename  	: port.hpp
* 
* Details   	: Contains definition of a structures `Port` and `Pins`. 
*
* Structure `Port` implements methods for setting, resetting and toggling a pin, 
...
private:
  ...
  static void inline Pass(Args... ) // Additional method for unpacking template. 
  {
  }
