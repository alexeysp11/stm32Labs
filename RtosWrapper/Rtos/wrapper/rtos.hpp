...
*               functions and also it contains a special static method Run. 
*
* In this method the pointer on Thread should be passed. 
* This method is input point as the task of Rtos. 
* In the body of the method, the method of concrete Thread will run.
* 
*******************************************************************************/
...
namespace OsWrapper
{
  ...
  public:
    ...
    *             [in] pName - name of task (facilitates debugging only). 
