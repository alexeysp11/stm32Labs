...
* 
* Details   	: Contains different imlementation for class `Singleton`. 
*               
* Class `Singleton` creates an instance of a friend class. 
* It is called in classes used in tasks e.g. `LedsController` or `ButtonHandler`. 
*
